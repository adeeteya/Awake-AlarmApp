              ...
              boxShadow: isChecked
                  ? [
                      ...
                      BoxShadow(
                        ...
                        blurRadius: 11,
                        spreadRadius: 2,
                        color: const Color(0xFFFD251E).withOpacity(0.35),
                      ),
                    ]
                  : (isDark)
                      ? [
                          BoxShadow(
                            ...
                            blurRadius: 4.9,
                            color: const Color(0xFF454D55).withOpacity(0.25),
                            inset: true,
                          ),
                          BoxShadow(
                            offset: const Offset(1.6, 1.3),
                      ...
                      : [
                          ...
                          BoxShadow(
                            offset: const Offset(1.6, 1.3),
                            blurRadius: 1.98,
                            color: const Color(0xFF63748B).withOpacity(0.2),
                            inset: true,
                          ),
                        ],
            ),
                    ...
                    : (isDark)
                        ? [
                            BoxShadow(
                              offset: const Offset(-3, -3),
                              blurRadius: 6,
                              color: const Color(0xFF454D56).withOpacity(0.52),
                            ),
                            BoxShadow(
                              offset: const Offset(3, 3),
                              blurRadius: 6,
                              color: const Color(0xFF181E24).withOpacity(0.65),
                            ),
                          ]
                        : [
                            BoxShadow(
                            ...
                            BoxShadow(
                              offset: const Offset(3, 3),
                              blurRadius: 6,
                              color: const Color(0xFFA6B4C8).withOpacity(0.65),
                            ),
                          ],
              ),
            ),
