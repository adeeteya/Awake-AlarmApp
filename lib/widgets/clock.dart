...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint clockBackgroundPaint = Paint()
    ...
    final Paint clockBackgroundBorderPaint = Paint()
      ..shader = LinearGradient(
    ...
    final Paint secondHandButtPaint = Paint()
      ..shader = const RadialGradient(
        colors: [
          Color(0xFFFD251E),
          Color(0xFFFE725C),
    ...
    final Paint minuteHandPaint = Paint()
      ...
      ..strokeCap = StrokeCap.round
      ..strokeWidth = 6;
    final Paint labelHandPaint = Paint()
      ..color = (isDark)
          ? const Color(0xFF5D666D)
    ...
    //draw label hands
    canvas.drawLine(Offset(centerX, centerY - radius + 20),
        Offset(centerX, centerY - radius + 30), labelHandPaint);
    canvas.drawLine(Offset(centerX, centerY + radius - 20),
        Offset(centerX, centerY + radius - 30), labelHandPaint);
    canvas.drawLine(Offset(centerX + radius - 30, centerY),
        Offset(centerX + radius - 20, centerY), labelHandPaint);
    canvas.drawLine(Offset(centerX - radius + 30, centerY),
        Offset(centerX - radius + 20, centerY), labelHandPaint);
    ...
    canvas.drawLine(Offset(secHandEndX, secHandEndY),
        Offset(secHandButtX, secHandButtY), secondHandButtPaint);
